...
describe('Assignment 1 - ShoppingCart', function() {
	...
	it('should be able to add items', function() {
		...
		assert.deepStrictEqual(cart.getItems(), [], 'Items should be an empty array, initially');
	...
	it('should be able to clear items', function() {
		...
		cart.addItem('Trash can', 1, 15.5);
		cart.clear();
		assert.deepStrictEqual(cart.getItems(), [], 'Items should be an empty after clear()');
	});
